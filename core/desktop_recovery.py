...
def select_window_recovery_strategy(
    ...
    *,
    ...
    attempts_allowed = min(max(0, int(max_attempts or 0)), recovery_budget_for_reason(reason)) if reason in _RECOVERY_BUDGET_BY_REASON else max(0, int(max_attempts or 0))
