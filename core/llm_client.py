        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Use desktop_list_windows, desktop_get_active_window, desktop_inspect_window_state, desktop_focus_window, desktop_recover_window, desktop_wait_for_window_ready, and desktop_capture_screenshot for bounded desktop inspection and recovery, and use desktop_click_point or desktop_type_text only after explicit approval when a single real desktop action is required. "
