        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "desktop_click_point, desktop_press_key, and desktop_type_text are approval-gated in this pass. Only pass approval_status=approved when the current goal explicitly says the paused desktop action is now approved. Never invent approval_status=approved on your own. "
                    "If the user wants a real desktop click, bounded key press, or type action that is not yet approved, you must still plan the corresponding desktop_click_point, desktop_press_key, or desktop_type_text call without approval_status=approved so the tool can create the structured paused checkpoint. Do not replace that with a prose-only approval request. "
                    ...
                    "Use desktop_list_windows, desktop_get_active_window, desktop_inspect_window_state, desktop_focus_window, desktop_recover_window, desktop_wait_for_window_ready, and desktop_capture_screenshot for bounded desktop inspection and recovery, and use desktop_click_point, desktop_press_key, or desktop_type_text only after explicit approval when a single real desktop action is required. "
